...
const Header = () => {
  ...
  return (
    <nav className='sticky top-0 z-50 border-b bg-white maincontainer'>
        ...
        <div className='relative flex items-center justify-between h-16'>
          ...
          <div className='flex items-center justify-center sm:items-stretch sm:justify-start'>
            <div className='flex-shrink-0 flex items-center '>
              <Link to='/'>
                <img className='w-20 mainlogo  ' src='https://res.cloudinary.com/df6uhxehr/image/upload/v1671031870/Logo/p-kartlogo_ydafp4.png' alt='' />
              </Link>
              <Link to='/'>
                <img className=' fuuastlogo  ' src='https://res.cloudinary.com/df6uhxehr/image/upload/v1671025938/Logo/fuuast_fwondz.png' alt='' />
              </Link>
              <Link to='/'>
                <img className='w-40  logonamee ' src='https://res.cloudinary.com/df6uhxehr/image/upload/v1670750811/Logo/P-Kart_d7wuy5.png' alt='' />
              </Link>

            </div>

          </div>
          <div className='flex sm:items-stretch sm:justify-start shpnow'>
          <Link to='/products' className='logoproduct' id='mycontrent'>
            {/* <button className='focus:outline-none hover:opacity-80 px-4 py-2 text-gray-700'>
            <img src={productlogo} style={{height:'30px'}}/>
            </button> */}
         
            <div className='productlogo'>SHOP</div>
            <span className='producttlogo'>NOW</span>
            </Link>
          </div>
